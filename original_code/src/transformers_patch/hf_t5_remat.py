...
print("FlaxSeq2SeqModelOutput:", FlaxSeq2SeqModelOutput)
append_call_sample_docstring(
    #FlaxT5Model, _TOKENIZER_FOR_DOC, _CHECKPOINT_FOR_DOC, FlaxSeq2SeqModelOutput, _CONFIG_FOR_DOC
    model_class=FlaxT5Model, checkpoint=_CHECKPOINT_FOR_DOC, output_type=FlaxSeq2SeqModelOutput, config_class=_CONFIG_FOR_DOC
)
