...
from core_cloud import TKInference, TKInferenceConfig, TKTrain, TKTrainConfig
...
def evaluate_loss(*, eval_dataset: Union[Seq2SeqDataset, Seq2SeqIterableDataset], 
                  inference: TKInference, mesh: Optional[Mesh], rng: jax.random.PRNGKey, bsize: int, 
...
def train_model(*, train_dataset: Union[Seq2SeqDataset, Seq2SeqIterableDataset], 
                ...
                rng: jax.random.PRNGKey, save_dir: Optional[str], max_checkpoints: Optional[int], 
